...
const locations = ["서울", "부산", "대구", "인천", "광주", "대전", "울산", "원격근무"]
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <Label>시간당 요금</Label>
              <div className="px-2">
                <Slider value={rateRange} onValueChange={setRateRange} max={200000} step={10000} className="w-full" />
